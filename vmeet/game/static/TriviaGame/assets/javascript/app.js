...
let music = {
	gameAudio: new Audio ("TriviaGame/assets/sounds/theme.mp3"),
	fadeout: function() {
...
var questionBank = [
	{
		...
		aIndex: 0,
		correctAnimation: "/static/TriviaGame/assets/images/dm-holiday-win.gif",
		wrongAnimation: "/static/TriviaGame/assets/images/kevin-stupidity-lose.gif"
...

	{
		...
		a: ["K.", "A.", "G.", "J."],
		aIndex: 2,
		correctAnimation: "/static/TriviaGame/assets/images/michael-running-win.gif",
		wrongAnimation: "/static/TriviaGame/assets/images/michael-explain-lose.gif"
...

	{
		...
		aIndex: 3,
		correctAnimation: "/static/TriviaGame/assets/images/dwight-true-win.gif" ,
		wrongAnimation: "/static/TriviaGame/assets/images/michael-no-lose.gif"
...

	{
		...
		aIndex: 0,
		correctAnimation: "/static/TriviaGame/assets/images/mspc-win.gif",
		wrongAnimation: "/static/TriviaGame/assets/images/jan-burn-lose.gif"
...

	{
		...
		aIndex: 1,
		correctAnimation: "/static/TriviaGame/assets/images/pam-nice-win.gif",
		wrongAnimation: "/static/TriviaGame/assets/images/jim-goingon-lose.gif"
...

	{
		...
		aIndex: 1,
		correctAnimation: "/static/TriviaGame/assets/images/pam-dundies-win.gif",
		wrongAnimation: "/static/TriviaGame/assets/images/ryan-notme-lose.gif"
...

	{
		...
		aIndex: 2,
		correctAnimation: "/static/TriviaGame/assets/images/michael-fine-win.gif",
		wrongAnimation: "/static/TriviaGame/assets/images/michael-inside-lose.gif"
...

	{
		...
		aIndex: 2,
		correctAnimation: "/static/TriviaGame/assets/images/jim-darrell-win.gif",
		wrongAnimation: "/static/TriviaGame/assets/images/kevin-chili-lose.gif"
...

	{
		...
		aIndex: 0,
		correctAnimation: "/static/TriviaGame/assets/images/angela-yes-win.gif",
		wrongAnimation: "/static/TriviaGame/assets/images/andy-hard-lose.gif"
...

	{
		...
		aIndex: 3,
		correctAnimation: "/static/TriviaGame/assets/images/michael-right-win.gif",
		wrongAnimation: "/static/TriviaGame/assets/images/dwight-crying-lose.gif"
...
var gameClock = {
	...
	tick : new Audio ("/static/TriviaGame/assets/sounds/switch.wav"),
